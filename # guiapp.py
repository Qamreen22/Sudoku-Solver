        ...
        for i in range(self.rows):
            for j in range(self.cols):
                if self.cubes[i][j].value == 0:
                    return False
        return True
#implementation of backtrack algorithm______________________________________________________________________________________________
    def solve(self):
...
class Cube:
    ...
    def draw(self, win):
        fnt = pygame.font.SysFont("times", 25)
...
def redraw_window(win, board, time, strikes):
    ...
    # Draw time
    fnt = pygame.font.SysFont("times", 23)
